...
import { HorizontalTripleDotSvg, ShareButtonsvg, ThumbDownDislikedSvg, ThumbDownSvg, ThumbUpLikedSvg, ThumbUpSvg } from "@/components/svgs";
...
export const Video = ({ params }: { params: { movieId: string } }) => {
