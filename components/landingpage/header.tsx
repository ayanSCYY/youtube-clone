...
export const Header = () => {
    ...
    return (    
        <div className="flex justify-between items-center h-auto p-5 w-full bg-[#0F0F0F] fixed top-0 z-50">
            ...
            <div className="max-sm:hidden w-3/5 flex "> 
            ...
            {showSearch && <input  type="text" placeholder="Search" className=" w-[70%] p-4 h-[45px] border-2 border-r-0 border-[#252525] placeholder-[#817F81] text-[#817F81] rounded-l-full bg-transparent " />}
            <div className="max-sm:w-2/5 flex justify-between gap-2 items-center">
                ...
                <div onClick={handleMenuClick} className="w-10 h-10 text-white bg-yellow-600 flex justify-center items-center hover:bg-yellow-600/[0.8] cursor-pointer rounded-full">{'h'.toUpperCase()}</div>
            </div>
